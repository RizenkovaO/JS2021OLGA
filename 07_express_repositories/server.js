...
const StudentsCtrl = require("./app/controllers/StudentsController");
...
server.get("/students/create", StudentsCtrl.renderForm);
server.post("/students/create", StudentsCtrl.create);
server.post("/students/delete/:studentId?", StudentsCtrl.delete);
server.post("/students/:studentId?", StudentsCtrl.update);
